	...
	<div class="main-top">
		<div class="container">
			<div class="row">
				<div class="col-lg-6">
					<div class="left-top">
						<a class="new-btn-d br-2" href="#"><span>Electronic Medical Record</span></a>
					</div>
				</div>
				<div class="col-lg-6">
					<div class="wel-nots">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbar-wd">
                    <ul class="navbar-nav">
                       ...
                       <li><a class="nav-link" href="#gallery">Gallery</a></li>
						<li><a class="nav-link" href="Forms/Login_form/indexL.html">Login</a></li>
						<li><a class="nav-link" href="Forms/Login_form/patientOrDoctor.html">Sign up</a></li>
					...
					<div class="col-lg-12 col-md-12 col-sm-12">
						<div class="row align-items-center about-main-info">
							<div class="col-lg-6 col-md-6 col-sm-12">
								<h1> Welcome to E-Health Book </h1>
								<p>Electronic Medical Record is a web-based application which is used to capture, organize, maintain and retrieve patient’s medical records on day-to-day basis.  </p>
							...
							<div class="col-lg-6 col-md-6 col-sm-12">
								<div class="about-m">
									<ul id="banner">
										<li>
											<img src="images/emr.jpg" alt="" width="50px" height="500px">
										</li>
										<li>
			...
			<div class="popup-gallery row clearfix">
				<div class="col-md-3 col-sm-6">
					<div class="box-gallery">
						<img src="https://tse1.mm.bing.net/th?id=OIP.-4klJtL_8XlZE5ICmt_YWwHaE8&pid=Api&P=0&w=264&h=176" alt="">
				...
				<div class="col-md-3 col-sm-6">
					<div class="box-gallery">
						<img src="https://tse2.mm.bing.net/th?id=OIP._VLZDwfPS-bNegstq_08wQHaD3&pid=Api&P=0&w=360&h=188" alt="">
						<div class="box-content">
							<h3 class="title">Lorem ipsum dolor</h3>
							<ul class="icon">
				...
				<div class="col-md-3 col-sm-6">					
					<div class="box-gallery">
						<img src="https://media.istockphoto.com/photos/electronic-medical-record-concept-picture-id904427688" alt="">
						<div class="box-content">							
							<ul class="icon">
				...
				<div class="col-md-3 col-sm-6">
					<div class="box-gallery">
						<img src="https://tse4.mm.bing.net/th?id=OIP.jWd2a5cehDvnQAM1wFBc0gHaDt&pid=Api&P=0&w=355&h=177" alt="">
						<div class="box-content">	
							<h3 class="title">Lorem ipsum dolor</h3>
							<ul class="icon">
				...
				<div class="col-md-3 col-sm-6">
					<div class="box-gallery">
						<img src="https://tse3.mm.bing.net/th?id=OIP.XDHdpPGzQVBaHy-q_UlDjgHaFj&pid=Api&P=0&w=230&h=172" alt="">
						<div class="box-content">							
							<h3 class="title">Lorem ipsum dolor</h3>
							<ul class="icon">
				...
				<div class="col-md-3 col-sm-6">					
					<div class="box-gallery">
						<img src="https://pmrpressrelease.com/wp-content/uploads/2019/07/Electronic-Medical-Records-Systems1.jpg" alt="">
						<div class="box-content">
							<h3 class="title">Lorem ipsum dolor</h3>
							<ul class="icon">
				...
				<div class="col-md-3 col-sm-6">
					<div class="box-gallery">
						<img src="https://tse2.mm.bing.net/th?id=OIP.zmRWSzVYdYXCdPbMCadZiQHaFC&pid=Api&P=0&w=258&h=176" alt="">
						<div class="box-content">
							<h3 class="title">Lorem ipsum dolor</h3>
							<ul class="icon">
