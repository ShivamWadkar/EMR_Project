...
<header class="ScriptHeader">
    <div class="rt-container">
        ...
        <h1 style="color:rgb(3, 54, 54);font-size:40px;font-style: italic;">My Profile</h1>
            </div>
        </div>
    </div>
</header>
 ...
 <div class="container-fluid" >
            <div class="row clearfix">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 m-t-10 align-right text-right">
                    <a href="/edit_patient_profile" class="btn btn-info waves-effect col-white">Edit</a>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-8">
          ...
          <div class="card-body pt-0">
            <table class="table table-bordered">
              ...
              <tr>
                ...
                <td width="2%">:</td>
                <td>shubhada.shinde10972gmail.com</td>
              </tr>
              <tr>
        ...
        <div class="card shadow-sm">
          <div class="card-header bg-transparent border-0">
            <h3 class="mb-0"><i class="far fa-clone pr-1"></i>Test Report Count</h3>
          </div>
