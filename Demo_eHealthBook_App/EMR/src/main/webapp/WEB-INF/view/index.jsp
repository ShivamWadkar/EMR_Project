			...
			<div class="row">
				<div class="pogoSlider" id="js-main-slider">
					...
					<div class="pogoSlider-slide" data-transition="fade"
						...
						<div class="lbox-caption pogoSlider-slide-element">
							<div class="lbox-details">
								<h1>We are here to maintain your health records</h1>
								<p></p>
										...
										<div class="subscribe-inner text-center clearfix">
											...
											<form action="#" method="post">
												<div class="form-group">
													<input class="form-control-1" id="name-1" name="name"
														placeholder="Name" required="" type="text"> <br>
													<br> <input class="form-control-1" id="message-1"
														name="message" placeholder="Message " required=""
														type="text">
												</div>
												<div class="form-group">
													<button type="submit" class="new-btn-d br-2">Send
														Message</button>
												</div>
											</form>
										</div>
